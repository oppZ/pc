...
def prise_en_compte_signaux(signum, frame) :
    ...
    sys.exit(0)
# ---------------------------------------------------
def arbitre_fct(verrou_fct: mp.Lock, pos_fct: mp.Array, pari: mp.Value):
    ...
    while keep_running.value:
        with verrou_fct:
            ...
            print("Le premier est", premier_index, "et la grosse merde est", dernier_index)
        time.sleep(.1)
    if pari.value == premier_index:
        print("Bien joué... mais vous n'avez rien gagne.")
    elif pari.value == dernier_index:
...
if __name__ == "__main__" :
    ...
    pari = mp.Value('I', int(input("Sur quel canasson pariez-vous? ")))
